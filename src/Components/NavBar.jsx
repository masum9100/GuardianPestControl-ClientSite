...
const NavBar = () => {
    ...
    return (
        <div className=''>
            ...
            <div className="navbar bg-base-100 max-w-screen-xl mx-auto text-center items-center my-0 lg:my-5">
                            ...
                            {user && <li tabIndex={0}>
                                <details>
                                    ...
                                    <ul className="p-2 w-40">
                                        ...
                                        <NavLink to={"/add-services"}><li><a>Add-services</a></li></NavLink>
                                        <NavLink to={"/my-schedule"}><li><a>My-schedules</a></li></NavLink>
                                    </ul>
                                </details>
                            </li>}
